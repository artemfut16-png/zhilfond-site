          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <Input
                ...
                required
                className="h-12 rounded-(--radius) border-none bg-primary-foreground px-5 text-base text-foreground placeholder:text-muted-foreground focus-visible:ring-primary-foreground/50 sm:w-72"
              />
              <Button
                type="submit"
                size="lg"
