    ...
    <section className="bg-stone-800 text-white">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-(--radius) border border-white/20">
            <Image
        ...
        <div className="mt-10 flex flex-col gap-4 rounded-(--radius) border border-white/15 bg-white/5 p-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          {submitted ? (
            <div className="flex items-center gap-2 rounded-(--radius) bg-white/10 px-5 py-3 text-sm">
            ...
            >
              ...
              <Input
                ...
                required
                className="h-12 rounded-(--radius) border-none bg-white px-5 text-base text-foreground placeholder:text-muted-foreground focus-visible:ring-white/50 sm:w-64"
              />
              <Button
                type="submit"
                size="lg"
                className="h-12 shrink-0 rounded-(--radius) border border-white/30 bg-white/10 text-white hover:bg-white/20"
              >
                Записаться
              </Button>
            </form>
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {steps.map((step, i) => (
            <div
              key={step}
              className="flex flex-col gap-4 rounded-(--radius) border border-white/15 bg-white/5 p-6"
            >
          ...
          <div className="flex flex-col justify-between gap-4 rounded-(--radius) border border-white/15 bg-white/5 p-6">
            <span className="text-2xl font-semibold text-white/40">
              04
            </span>
